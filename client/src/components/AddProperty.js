                ...
                <FormControl className="addProperty">
                    ...
                    <Grid container spacing={2} justify="space-around" direction="row" alignItems="flex-start">
                        <Grid container item justify="space-around">
                            ...
                            <div className="addPropertyInput">
                                <TextField variant="outlined" type="text" label="status:" InputLabelProps={{ shrink: true, }} type="text" name="status" id="status" value={inputs.status} onChange={(event) => setInputs({ ...inputs, status: event.target.value })} />
                            </div>
                            <div className="addPropertyInput">
                        ...
                        <Grid>
                            ...
                            <Button variant="contained" color="primary" onClick={addProperty}>Add Property!</Button>
                        </Grid>
                    </Grid>
                </FormControl>
            </Container>
