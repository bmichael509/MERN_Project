...
const styles = {
    ...
    return (
        ...
        <FormControl onSubmit={addEmployee} className="addEmployee">
            ...
            <div className="addEmployeeInput">
                <TextField variant="outlined" label="Financial Check Notes:" InputLabelProps={{shrink: true,}} type="text" name="financialNotes" id="financialNotes" value={inputs.financialNotes} onChange={(event) => setInputs({ ...inputs, financialNotes: event.target.value })} />
            </div>
            </Grid>
            <Grid>
